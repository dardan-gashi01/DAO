 ...
 */
export declare function updateExistingClaimConditions(index: number, claimConditionInput: ClaimConditionInput, existingConditions: ClaimCondition[], tokenDecimals: number): Promise<ClaimConditionInput[]>;
/**
 ...
 * @internal
 */
export declare function processClaimConditionInputs(claimConditionInputs: ClaimConditionInput[], tokenDecimals: number, provider: Provider, storage: IStorage): Promise<{
    snapshotInfos: {
        merkleRoot: string;
        snapshotUri: string;
        snapshot: {
