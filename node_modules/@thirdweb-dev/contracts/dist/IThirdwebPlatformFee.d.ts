import { utils, BigNumberish, BytesLike, BaseContract, Signer, CallOverrides, Overrides, ContractTransaction, BigNumber, PopulatedTransaction } from 'ethers';
...
interface IThirdwebPlatformFeeInterface extends utils.Interface {
    contractName: string | "IThirdwebPlatformFee";
    functions: {
...
interface IThirdwebPlatformFee extends BaseContract {
    contractName: string | "IThirdwebPlatformFee";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IThirdwebPlatformFeeInterface;
...
export { IThirdwebPlatformFee, IThirdwebPlatformFeeInterface };
