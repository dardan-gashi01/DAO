...
interface DropERC1155Interface extends utils.Interface {
    contractName: string | "DropERC1155";
    functions: {
        ...
        "verifyClaim(uint256,address,uint256,uint256,address,uint256)": FunctionFragment;
...
interface DropERC1155 extends BaseContract {
    contractName: string | "DropERC1155";
    ...
    functions: {
        ...
        verifyClaim(_conditionId: BigNumberish, _claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, _currency: string, _pricePerToken: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
    ...
    estimateGas: {
        ...
        verifyClaim(_conditionId: BigNumberish, _claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, _currency: string, _pricePerToken: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        verifyClaim(_conditionId: BigNumberish, _claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, _currency: string, _pricePerToken: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
export { ApprovalForAllEvent, ApprovalForAllEventFilter, ClaimConditionsUpdatedEvent, ClaimConditionsUpdatedEventFilter, DefaultRoyaltyEvent, DefaultRoyaltyEventFilter, DropERC1155, DropERC1155Interface, IDropClaimCondition, MaxTotalSupplyUpdatedEvent, MaxTotalSupplyUpdatedEventFilter, MaxWalletClaimCountUpdatedEvent, MaxWalletClaimCountUpdatedEventFilter, OwnerUpdatedEvent, OwnerUpdatedEventFilter, PlatformFeeInfoUpdatedEvent, PlatformFeeInfoUpdatedEventFilter, PrimarySaleRecipientUpdatedEvent, PrimarySaleRecipientUpdatedEventFilter, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter, RoyaltyForTokenEvent, RoyaltyForTokenEventFilter, TokensClaimedEvent, TokensClaimedEventFilter, TokensLazyMintedEvent, TokensLazyMintedEventFilter, TransferBatchEvent, TransferBatchEventFilter, TransferSingleEvent, TransferSingleEventFilter, URIEvent, URIEventFilter, WalletClaimCountUpdatedEvent, WalletClaimCountUpdatedEventFilter };
